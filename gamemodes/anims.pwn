...
// Animations script for Africa City Rp
// Animations script for Africa City Rp
// Animations script for Africa City Rp
// Animations script for Africa City Rp
...
#define SERVER_COLOR2 0xFF9900FF
IsCLowrider(carid)
{
...
CMD:crack(playerid, params[])
{
	...
	switch(strval(params))
	{
	    ...
	    default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /crack [1-4]");
	}
    return 1;
}
...
CMD:rap(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /rap [1-3]");
	}
	return 1;
}
...
CMD:wank(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /wank [1-3]");
	}
	return 1;
}
...
CMD:chat(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /chat [1-9]");
	}
	return 1;
}
...
CMD:sitonchair(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /sitonchair [1-7]");
	}
	return 1;
}
...
CMD:bat(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /bat [1-3]");
	}
	return 1;
}
...
CMD:lean(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /lean [1-2]");
	}
	return 1;
}
...
CMD:gesture(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /gesture [1-15]");
	}
	return 1;
}
...
CMD:lay(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /lay [1-3]");
	}
	return 1;
}
...
CMD:wave(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /wave [1-3]");
	}
	return 1;
}
...
CMD:signal(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /signal [1-2]");
	}
	return 1;
}
...
CMD:nobreath(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /nobreath [1-3]");
	}
	return 1;
}
...
CMD:fallover(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /fallover [1-5]");
	}
	return 1;
}
...
CMD:pedmove(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /pedmove [1-26]");
	}
	return 1;
}
...
CMD:getjiggy(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /getjiggy [1-10]");
	}
	return 1;
}
...
CMD:stripclub(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /stripclub [1-2]");
	}
	return 1;
}
...
CMD:smoke(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /smoke [1-2]");
	}
	return 1;
}
...
CMD:dj(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /dj [1-4]");
	}
	return 1;
}
...
CMD:reload(playerid, params[])
{
	...
	switch(strval(params))
	{
	    ...
	    default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /reload [1-4]");
	}
	return 1;
}
...
CMD:tag(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /tag [1-2]");
	}
	return 1;
}
...
CMD:deal(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /deal [1-2]");
	}
	return 1;
}
...
CMD:crossarms(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /crossarms [1-5]");
	}
	return 1;
}
...
CMD:cheer(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /cheer [1-8]");
	}
	return 1;
}
...
CMD:sit(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /sit [1-5]");
	}
	return 1;
}
...
CMD:siteat(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /siteat [1-2]");
	}
	return 1;
}
...
CMD:bar(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /bar [1-5]");
	}
	return 1;
}
...
CMD:dance(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /dance [1-14]");
	}
...
CMD:spank(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /spank [1-4]");
	}
	return 1;
}
...
CMD:sexy(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /sexy [1-6]");
	}
	return 1;
}
...
CMD:holdup(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /holdup [1-2]");
	}
	return 1;
}
...
CMD:copa(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /copa [1-9]");
	}
	return 1;
}
...
CMD:misc(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /misc [1-2]");
	}
	return 1;
}
...
CMD:snatch(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /snatch [1-2]");
	}
	return 1;
}
...
CMD:blowjob(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /blowjob [1-2]");
	}
	return 1;
}
...
CMD:kiss(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /kiss [1-6]");
	}
	return 1;
}
...
CMD:idles(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /idles [1-15]");
	}
	return 1;
}
...
CMD:sunbathe(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /sunbathe [1-18]");
	}
	return 1;
}
...
CMD:lowrider(playerid, params[])
{
	...
	if(IsCLowrider(GetPlayerVehicleID(playerid)))
	{
		...
		default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /lowrider [1-31]");
		}
	}
	else
	{
...
CMD:carchat(playerid, params[])
{
	...
	default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /carchat [1-19]");
	}
	return 1;
}
...
CMD:point(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /point [1-2]");
	}
...
CMD:tired(playerid, params[])
{
	...
	switch(strval(params))
	{
	    ...
	    default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /tired [1-2]");
	}
...
CMD:injured(playerid, params[])
{
	...
	switch(strval(params))
	{
	    ...
	    default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /injured [1-2]");
	}
...
CMD:aim(playerid, params[])
{
	...
	switch(strval(params))
	{
	    ...
	    default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /aim [1-2]");
	}
...
CMD:traffic(playerid, params[])
{
	...
	switch(strval(params))
	{
        ...
        case 2: ApplyAnimationEx(playerid, "POLICE", "CopTraf_Come", 4.1, 0, 0, 0, 0, 0);
	    default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /traffic [1-2]");
	}
...
CMD:ghands(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /ghands [1-10]");
	}
...
CMD:walk(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /walk [1-15]");
	}
...
CMD:fuckme(playerid, params[])
{
	...
	switch(strval(params))
	{
        ...
        default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /fuckme [1-8]");
	}
...
CMD:bj(playerid, params[])
{
	...
	switch(strval(params))
	{
        ...
        default: SendClientMessage(playerid, SERVER_COLOR2, "[USAGE]{ffffff} /bj [1-12]");
	}
