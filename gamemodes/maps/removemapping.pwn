RemoveBuildings(playerid)
{
    ...
    // Workshop selfrepair
  //  RemoveBuildingForPlayer(playerid, 5407, 2041.650, -1682.189, 12.570, 0.250);
	//RemoveBuildingForPlayer(playerid, 5547, 2041.650, -1682.189, 12.570, 0.250);
	RemoveBuildingForPlayer(playerid, 1498, 2064.580, -1704.300, 13.343, 0.250);
    
    
    // Basement Underground 
    RemoveBuildingForPlayer(playerid, 3421, 2351.828, -652.921, 129.187, 0.250);
    RemoveBuildingForPlayer(playerid, 3414, 2351.828, -652.921, 129.187, 0.250);
	...
	// remove dyor gangshit
	RemoveBuildingForPlayer(playerid, 1308, 1978.859, -1742.569, 12.703, 0.250);
	RemoveBuildingForPlayer(playerid, 1226, 1979.420, -1748.160, 16.398, 0.250);
	...
	RemoveBuildingForPlayer(playerid, 1308, 1991.969, -1714.130, 12.781, 0.250);
	...
	RemoveBuildingForPlayer(playerid, 1308, 1991.979, -1668.369, 12.781, 0.250);
	...
	// Hotel
	RemoveBuildingForPlayer(playerid, 17350, -63.414001, -1115.410034, 0.046000, 50.000000);
	RemoveBuildingForPlayer(playerid, 17073, -63.414001, -1115.410034, 0.046000, 50.000000);
	RemoveBuildingForPlayer(playerid, 17072, -63.414001, -1115.410034, 0.046000, 50.000000);
	RemoveBuildingForPlayer(playerid, 1438, -63.414001, -1115.410034, 0.046000, 0.250000);
	RemoveBuildingForPlayer(playerid, 1462, -60.359001, -1116.938965, 0.257000, 0.250000);
	RemoveBuildingForPlayer(playerid, 1438, -63.671001, -1125.698975, 0.046000, 0.250000);
	RemoveBuildingForPlayer(playerid, 3285, -73.804001, -1141.420044, 1.984000, 0.250000);
	RemoveBuildingForPlayer(playerid, 1462, -79.250000, -1137.718994, 0.054000, 0.250000);
	RemoveBuildingForPlayer(playerid, 1415, -68.350998, -1104.989014, 0.218000, 0.250000);
	RemoveBuildingForPlayer(playerid, 1415, -63.812000, -1106.420044, 0.218000, 0.250000);
	RemoveBuildingForPlayer(playerid, 1438, -87.054001, -1132.680054, 0.046000, 0.250000);
	RemoveBuildingForPlayer(playerid, 17301, -49.389999, -1140.869019, 5.203000, 0.250000);
	RemoveBuildingForPlayer(playerid, 17421, -49.389999, -1140.869019, 5.203000, 0.250000);
	RemoveBuildingForPlayer(playerid, 1447, -89.929001, -1133.750000, 1.390000, 0.250000);
	RemoveBuildingForPlayer(playerid, 1447, -84.054001, -1117.218994, 1.390000, 0.250000);
	...
	RemoveBuildingForPlayer(playerid, 1297, 1252.430, -1567.530, 15.859, 0.250);

    // Hospital Illegal
    RemoveBuildingForPlayer(playerid, 3676, 1323.7600, -1091.9399, 30.1250, 0.10); // lawnhouseredA
	RemoveBuildingForPlayer(playerid, 3679, 1323.7600, -1091.9399, 30.1250, 0.10); // LOD Model of lawnhouseredA
	RemoveBuildingForPlayer(playerid, 3677, 1323.7600, -1066.4300, 33.7108, 0.10); // lawnhousegreyLS
	RemoveBuildingForPlayer(playerid, 3681, 1323.7600, -1066.4300, 33.7108, 0.10); // LOD Model of lawnhousegreyLS
	...
	//Camping
	RemoveBuildingForPlayer(playerid, 784, -2367.976, -1944.000, 305.804, 0.250);
	...
	//Black HP
	RemoveBuildingForPlayer(playerid, 3327, 2195.187, -63.320, 28.812, 0.250);
	RemoveBuildingForPlayer(playerid, 3329, 2194.757, -92.359, 26.468, 0.250);
	RemoveBuildingForPlayer(playerid, 13461, 2373.234, 29.171, 30.343, 0.250);
	RemoveBuildingForPlayer(playerid, 3328, 2194.757, -34.273, 26.468, 0.250);
	RemoveBuildingForPlayer(playerid, 13374, 2241.406, 21.460, 33.171, 0.250);
	RemoveBuildingForPlayer(playerid, 3314, 2194.757, -92.359, 26.468, 0.250);
	RemoveBuildingForPlayer(playerid, 773, 2208.695, -71.593, 25.640, 0.250);
	RemoveBuildingForPlayer(playerid, 781, 2207.382, -97.601, 25.992, 0.250);
	RemoveBuildingForPlayer(playerid, 1408, 2205.664, -83.343, 26.421, 0.250);
	RemoveBuildingForPlayer(playerid, 1408, 2200.031, -83.343, 26.718, 0.250);
	RemoveBuildingForPlayer(playerid, 1294, 2215.539, -75.789, 29.812, 0.250);
	RemoveBuildingForPlayer(playerid, 781, 2211.687, -84.648, 25.578, 0.250);
	RemoveBuildingForPlayer(playerid, 1408, 2213.742, -98.117, 26.054, 0.250);
	RemoveBuildingForPlayer(playerid, 1408, 2213.742, -92.710, 26.054, 0.250);
	RemoveBuildingForPlayer(playerid, 1408, 2211.203, -83.343, 26.140, 0.250);
	RemoveBuildingForPlayer(playerid, 3408, 2213.773, -83.960, 25.484, 0.250);
	RemoveBuildingForPlayer(playerid, 766, 2179.953, -53.632, 25.914, 0.250);
	RemoveBuildingForPlayer(playerid, 1446, 2179.367, -50.750, 28.179, 0.250);
	RemoveBuildingForPlayer(playerid, 1446, 2184.101, -50.750, 28.179, 0.250);
	RemoveBuildingForPlayer(playerid, 1446, 2188.828, -50.750, 28.179, 0.250);
	RemoveBuildingForPlayer(playerid, 3316, 2195.187, -63.320, 28.812, 0.250);
	RemoveBuildingForPlayer(playerid, 1308, 2214.203, -50.843, 25.679, 0.250);
	RemoveBuildingForPlayer(playerid, 1446, 2207.734, -50.750, 27.523, 0.250);
	RemoveBuildingForPlayer(playerid, 1446, 2203.031, -50.750, 27.757, 0.250);
	RemoveBuildingForPlayer(playerid, 1446, 2193.562, -50.750, 28.179, 0.250);
	RemoveBuildingForPlayer(playerid, 1446, 2212.000, -50.750, 27.312, 0.250);
	RemoveBuildingForPlayer(playerid, 1446, 2198.304, -50.750, 28.000, 0.250);
	RemoveBuildingForPlayer(playerid, 1446, 2195.726, -53.320, 28.226, 0.250);
	RemoveBuildingForPlayer(playerid, 3407, 2213.437, -57.054, 25.476, 0.250);
	RemoveBuildingForPlayer(playerid, 3407, 2213.437, -50.164, 25.476, 0.250);
	RemoveBuildingForPlayer(playerid, 3315, 2194.757, -34.273, 26.468, 0.250);
	RemoveBuildingForPlayer(playerid, 780, 2210.046, -33.554, 25.640, 0.250);
	RemoveBuildingForPlayer(playerid, 1408, 2213.742, -34.421, 26.039, 0.250);
	RemoveBuildingForPlayer(playerid, 1408, 2213.742, -29.015, 26.039, 0.250);
...
*/
	...
	//Mansion///////////////////////////////////////////////////////////////////////////////////////////////
	RemoveBuildingForPlayer(playerid, 708, 2308.507, -956.625, 65.445, 0.250);
	RemoveBuildingForPlayer(playerid, 617, 2334.656, -1006.656, 57.648, 0.250);
